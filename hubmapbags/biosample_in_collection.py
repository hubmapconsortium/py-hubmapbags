...
def _build_dataframe( biosample_id, hubmap_id ):
    ...
    headers = ['biosample_id_namespace','biosample_local_id','collection_id_namespace','collection_local_id'] 
...
def create_manifest( biosample_id, hubmap_id, output_directory ):
